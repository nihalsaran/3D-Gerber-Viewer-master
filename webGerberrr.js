...
$(function () {
    ...
    // Step 1 box, the comments are for the original demo.
    var main = $('<div class=main>').appendTo('body').append($('<h1>').html('Step 1:<br>Select gerber files'/*+'<br>(or click for a demo board)'*/)/*.click(function() {
    main.remove();
    setTimeout(function() {
...
var fileInput = $('<input type="file" multiple accept=".zip">').appendTo(main);
